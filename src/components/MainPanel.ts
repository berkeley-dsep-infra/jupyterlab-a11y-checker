...
export class A11yMainPanel extends Widget {
  ...
  constructor() {
            ...
            <div class="main-container">
                ...
                <div class="controls-container">
                    ...
                    <button class="control-button analyze">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.456 3.75v5.09a3 3 0 0 1-.557 1.742l-1.736 2.436M9.456 3.75h-1.65m1.65 0h5.088m0 0v5.09a3 3 0 0 0 .557 1.742l1.736 2.436M14.544 3.75h1.65m-9.031 9.268l-2.378 3.337a2.465 2.465 0 0 0 2.007 3.895h10.416a2.465 2.465 0 0 0 2.007-3.895l-2.378-3.337m-9.674 0h9.674"/></svg>                        
                      Analyze Notebook
                    </button>
                </div>
    ...
    closeButton?.addEventListener('click', () => {
      const noticeSection = this.node.querySelector(
        '.notice-section'
      ) as HTMLElement;
      if (noticeSection) {
  ...
  private async analyzeCurrentNotebook() {
    if (!this.currentNotebook || !this.categoriesContainer) {
      return;
    }

    const analyzeButton = this.node.querySelector(
      '.analyze'
    ...
    try {
      ...
      // Create category widgets for each category, ensuring "Other" is last
      ...
      sortedCategories.forEach(categoryTitle => {
        ...
        const categoryWidget = new CellCategoryWidget(
